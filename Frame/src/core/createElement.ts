...
import { RouterCapsule } from "./router";

export const createElement = (data: ElementData, component: void, shadow: ShadowRoot | null = null, parentComponent: void | null = null, shouldaddToActiveComponent: boolean = false): HTMLElement => {
